...
extension UIView {
    ...
    @available(iOS 11.0, *)
    func setRoundCorners(_ corners: CACornerMask = [.layerMinXMinYCorner, .layerMaxXMinYCorner, .layerMinXMaxYCorner, .layerMaxXMaxYCorner], radius: CGFloat,maskToBounds:Bool = true) {
