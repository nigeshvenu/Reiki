...
public struct MonthStyle {
    ...
    public var titleFormatterHyphen: DateFormatter = {
        let format = DateFormatter()
        format.dateFormat = "MMMM - yyyy"
        return format
    }()
...
public struct YearStyle {
    ...
    public var colorBackgroundSelectDate: UIColor = .black
    public var colorSelectDate: UIColor = .white
    public var colorWeekendDate: UIColor = .black
    ...
    public var fontTitle: UIFont = FontHelper.montserratFontSize(fontType: .semiBold, size: 12.0)
    ...
    public var fontDayTitlePhone: UIFont = .systemFont(ofSize: 6)
